...
public class CataRaidBastionedelcrepuscolo extends Activity 
implements OnClickListener {
	    ...
	    public void onCreate (Bundle savedInstanceState) {
	      ...
	      /**  
	        ...
	        Button chog = (Button) findViewById(R.id.chogall);
	        ...
	        chog.setOnClickListener(new View.OnClickListener() {
	            @Override
	            public void onClick(View arg0 ) {

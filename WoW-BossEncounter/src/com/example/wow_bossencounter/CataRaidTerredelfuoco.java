...
public class CataRaidTerredelfuoco extends Activity 
implements OnClickListener {
		...
		@Override    
         public void onClick(View View) {    
           ...
           Object activity_cata_terre_raid;
	    ...
	    public void onCreate (Bundle savedInstanceState) {
	        ...
	        Button bale = (Button) findViewById(R.id.baleroc);
	        Button majo = (Button) findViewById(R.id.majordomo);
	        Button ragn = (Button) findViewById(R.id.ragnaros);
	        
	        beth.setOnClickListener(new View.OnClickListener() {
	            @Override
	        ...
	        alys.setOnClickListener(new View.OnClickListener() {
	            @Override
	            public void onClick(View arg0 ) {
	        ...
	        ragn.setOnClickListener(new View.OnClickListener() {
	            @Override
	            public void onClick(View arg0 ) {
